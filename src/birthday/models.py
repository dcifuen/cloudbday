...
class Client(models.Model):
    ...
    secondary_domains = ListField(help_text="Google Apps secondary domains of the organization")
    ...
    from_name = models.CharField(max_length=128, help_text="Name of the sender")
